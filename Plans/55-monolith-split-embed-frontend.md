...
- оставшийся долг — inline handlers в обычных формах, журналах, query/dev tools
  и админках. Их нужно выносить отдельными PR через явный bootstrap
  JSON/data-атрибуты и браузерную проверку конкретных экранов, а не
