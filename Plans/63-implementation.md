...
- [x] **Step 3: Добавить хелпер и переписать parseCatalogs**
...
- [x] **Step 1: Написать падающий тест на константы и регистры сведений**
...
- [x] **Step 3: Переписать остальные парсеры**
...
- [x] **Step 3: Реализовать sanitizeBSL и применить**
